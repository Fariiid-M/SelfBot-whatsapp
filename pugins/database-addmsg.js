...
let handler = async (m, { conn, command, usedPrefix, text }) => {
    ...
    if (text in msgs) return conn.sendButton(m.chat, `'${text}' telah terdaftar, gunakan nama lain!`, '', 'Daftar Pesan', `${usedPrefix}list${which}`, m)
...
Jika Getmsg diaktifkan maka tidak perlu lagi mengetik *${usedPrefix}get${which}*`, '', 'Aktifkan', '.autogetmsg on', m)
}
